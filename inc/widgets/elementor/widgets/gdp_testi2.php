...
class GDP_Testi2 extends Widget_Base {
    public function get_name() { return 'gdp-testimonials2'; }
    public function get_title() { return 'GDP Testimonials 2'; }
    public function get_icon() { return 'eicon-testimonial'; }
    public function get_categories() { return ['gdp-widgets']; }

    // Tambahkan dependency Animated.css dan Swiper.js
    public function get_style_depends() {
        return ['animate-css', 'swiper'];
    }
    ...
    protected function render() {
        ...
        <section class="gdp-testimonials2 py-16 lg:py-24" 
                ...
                <div class="swiper-container">
                    <div class="swiper-wrapper">
                        <?php foreach ($settings['testimonials'] as $testimonial) : ?>
                            <div class="swiper-slide p-6 rounded-lg shadow-lg bg-white transition-transform transform hover:scale-105 animate__animated animate__fadeInUp">
